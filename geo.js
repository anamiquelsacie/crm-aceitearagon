...
// ============================================================
import { vigilarSesion, salir } from "./auth.js?v=25";
import {
...
} from "./clientes.js?v=25";
import { htmlHistorico, conectarHistorico } from "./interacciones.js?v=25";
import { initMapa, refrescarMapa, setAbrirFicha } from "./mapa.js?v=25";
import { initPlantillas } from "./plantillasUI.js?v=25";
